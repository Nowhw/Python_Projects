...
class ImageToPDFConverter:
    ...
    def convert_images_to_pdf(self):
        ...
        pdf = canvas.Canvas(output_pdf_path, pagesize=(612, 792))  # Letter size (8.5" x 11")
        ...
        for image_path in self.image_paths:
            ...
            # Set white background using RGB
            pdf.setFillColorRGB(255, 255, 255)  # Correct method to set white background
            pdf.rect(0, 0, 612, 792, fill=True)  # Draw the white background
